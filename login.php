...
<head>
    ...
    <title>Expert System on Descriptive and Prescription for Hypertensive Patients</title>
    <!-- Custom CSS -->
            ...
            <div class="auth-box bg-white border-top border-secondary">
                <div id="loginform"><?php $lib->msg();?>
                    <div class="text-center p-t-20 p-b-20">
                        <span style="color: #333;font-size: 18px;">Expert System on Descriptive and Prescription for Hypertensive Patients</span>
                    </div>
                    <!-- Form -->
                    <form class="form-horizontal m-t-20" id="loginform" action="login.php" method="post">
                        <div class="row p-b-30">
                            <div class="col-12">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control form-control-lg" placeholder="Password" aria-label="Password" aria-describedby="basic-addon1" name="password" required="required">
                                </div>
                            </div>
                        </div>
                        <div class="row border-top border-secondary">
                            <div class="col-12">
                              ...
                              <span><a href="index.php"  style="color:#333;"><i class="ti-home"></i>&nbsp;&nbsp;&nbsp;Back to Home</a></span>
                            </div>
                        </div>
                    </form>
                </div>
