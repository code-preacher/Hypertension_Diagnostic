        ...
        <div class="page-wrapper">
                                       ...
                                       <div class="row p-t-20">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                               ...
                                               <input class="form-control custom-select" value="<?=$d['age']?>" disabled="disabled">
                                            </div>
                                        </div>
            ...
            <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control custom-select" value="<?php if ($d['ulcer']=='1') { echo "Yes"; } else { echo "No"; } ?>" disabled="disabled">
                </div>
            </div>
            <!--/span-->
            ...
            <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control custom-select" value="<?php if ($d['preg']=='1') { echo "Yes"; } else { echo "No"; } ?>" disabled="disabled">
                </div>
            </div>
            <!--/span-->
